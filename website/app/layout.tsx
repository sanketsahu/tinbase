  ...
  '@graph': [
    {
      ...
      downloadUrl: 'https://github.com/sanketsahu/tinbase/releases',
      softwareVersion: '0.1.0',
      releaseNotes: 'https://github.com/sanketsahu/tinbase/releases',
    },
    {
      '@type': 'SoftwareSourceCode',
      name: 'tinbase',
      codeRepository: 'https://github.com/sanketsahu/tinbase',
