...
const DATA = [
  { name: 'tinbase (pg-mem)', db: 'Postgres (pg-mem fork) · in-memory', logo: '/logo.svg', self: true, browser: true, install: 6.7, ram: 185, note: 'pure JS, no WASM — lightest to ship; more RAM under load' },
